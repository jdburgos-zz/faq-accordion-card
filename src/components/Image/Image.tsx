  ...
  <div className={styles.image}>
    <picture className={styles['image-box']}>
      <source
        ...
        srcSet={`${process.env.PUBLIC_URL}/images/illustration-box-desktop.svg`}
      />
    ...
    <picture className={styles['image-main']}>
      <source
        media="(min-width: 992px)"
        srcSet={`${process.env.PUBLIC_URL}/images/illustration-woman-online-desktop.svg`}
      />
      <img
    ...
    <picture className={styles['image-shadow']}>
      <source
        media="(min-width: 992px)"
        srcSet={`${process.env.PUBLIC_URL}/images/bg-pattern-desktop.svg`}
      />
